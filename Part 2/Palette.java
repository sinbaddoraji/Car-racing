...
public class Palette extends JPanel implements ActionListener, KeyListener
{
    ...
    public void keyPressed(KeyEvent e) 
    {
        if(!timer.isRunning() && e.getKeyCode() != KeyEvent.VK_R) return;
            switch (e.getKeyCode()) {
                //Key control for car 1
                 case KeyEvent.VK_UP:    IncreaseCarSpeed(0); break;
                 case KeyEvent.VK_DOWN:  ReduceCarSpeed(0);   break;
                 case KeyEvent.VK_LEFT:  rotateLeft(0);       break;
                 case KeyEvent.VK_RIGHT: rotateRight(0);      break;
                
                //Car control for car 2
                case KeyEvent.VK_W:   IncreaseCarSpeed(1); break;
                case KeyEvent.VK_S:   ReduceCarSpeed(1);   break;
                case KeyEvent.VK_A:   rotateLeft(1);       break;
                case KeyEvent.VK_D:   rotateRight(1);      break;
                default: break;
